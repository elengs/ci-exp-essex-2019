...
Calculate $E(\text{Ideology} | \text{Dem} = 0)$ -- wide data, as counts.
...
Calculate $E(\text{Ideology} | \text{Dem} = 0)$ -- wide data, as probs.
...
$$\widehat{\overline{Y_1 - Y_0}} = \left(\widehat{Y_1} | T_i = 1 \right) - 
\left(\widehat{Y_0} | T_i = 0 \right)$$
